...
public class WSDLComparatorPortTypeTest extends TestCase {

    private final Log log = LogFactory.getLog(WSDLComparatorPortTypeTest.class);


    public void testPorttypesSameWSDLV1() throws WSDLException, ComparisonException {
    ...
    public void testPorttypesSameWSDLV2() throws WSDLException, ComparisonException {
        TestDiffGeneratorFactory factory = new TestDiffGeneratorFactory();
        DiffGenerator flow = factory.getDiffGenerator();
    ...
    public void testPorttypesAddition() throws WSDLException, ComparisonException {
        TestDiffGeneratorFactory factory = new TestDiffGeneratorFactory();
        DiffGenerator flow = factory.getDiffGenerator();
        Definition originalWSDL = WSDLTestUtils.loadWSDL("/wsdl/tempconvert.wsdl");
        Definition changedWSDL = WSDLTestUtils.loadWSDL("/wsdl/tempconvert-porttype-changed.wsdl");
        Comparison comparison = flow.compare(changedWSDL, originalWSDL, ComparatorConstants.WSDL_MEDIA_TYPE);
        WSDLComparisonUtils.print(comparison);
        assertNotNull(comparison);
    }

    public void testPorttypesRemoval() throws WSDLException, ComparisonException {
        TestDiffGeneratorFactory factory = new TestDiffGeneratorFactory();
        DiffGenerator flow = factory.getDiffGenerator();
        Definition originalWSDL = WSDLTestUtils.loadWSDL("/wsdl/tempconvert.wsdl");
        Definition changedWSDL = WSDLTestUtils.loadWSDL("/wsdl/tempconvert-porttype-changed.wsdl");
