...
//TODO:
// 1. create providers for new models and versions
// 2.
...
public abstract class Base {
    ...
    public ServiceVersion[] getVersions() throws MetadataException {
        ArrayList<VersionBase> list = getAllVersions(uuid, versionMediaType);
        ServiceVersion[] arr = new ServiceVersion[list.size()];
        arr = list.toArray(arr);
        return arr;
    }


    public ServiceVersion getVersion(int major, int minor, int patch) throws MetadataException {
        ...
        for (VersionBase v : getAllVersions(uuid, versionMediaType)) {
            ServiceVersion http = (ServiceVersion) v;
