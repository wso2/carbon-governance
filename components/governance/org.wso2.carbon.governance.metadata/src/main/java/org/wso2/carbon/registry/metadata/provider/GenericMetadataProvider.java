...
public class GenericMetadataProvider implements BaseProvider {

    private static final Log log = LogFactory.getLog(GenericMetadataProvider.class);

    private final String mediaType;
    private final String versionMediaType;


    public GenericMetadataProvider(String mediaType, String versionMediaType) {
    ...
    private void createPropertiesContent(GenericMetadata service, OMElement element) {
        OMFactory factory = OMAbstractFactory.getOMFactory();
