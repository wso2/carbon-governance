...
public class GenericVersion extends VersionBase {
...
//  Variables defined for internal implementation purpose
    ...
    private static final Log log = LogFactory.getLog(GenericVersion.class);

    public GenericVersion(Registry registry, String name) throws MetadataException {
        super(mediaType,name,registry);
        this.name = name;
    }

    public GenericVersion(Registry registry, String name, String uuid, String baseName, String baseUUID, Map<String, List<String>> propertyBag, Map<String, List<String>> attributeMap) throws MetadataException {
     ...
     */
    public static GenericVersion[] getAll(Registry registry) throws MetadataException {
        List<VersionBase> list = getAll(registry, mediaType);
        return list.toArray(new GenericVersion[list.size()]);
    }
     ...
     * @return
     */
    public static GenericVersion[] find(Registry registry, Map<String, String> criteria) throws MetadataException {
     ...
     */
    public static GenericVersion get(Registry registry, String uuid) throws MetadataException {
        return (GenericVersion) get(registry, uuid, mediaType);
    }
