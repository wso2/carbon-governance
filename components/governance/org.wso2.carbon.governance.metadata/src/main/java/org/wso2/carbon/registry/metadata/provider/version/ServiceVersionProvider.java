...
public class ServiceVersionProvider implements VersionBaseProvider {

    private static final Log log = LogFactory.getLog(ServiceVersionProvider.class);

    private String mediaType;


    public ServiceVersionProvider(String mediaType) {
    ...
    public Resource buildResource(VersionBase metadata, Resource resource) throws MetadataException {
        ...
        createAttributesContent((ServiceVersion) metadata, attributes);
        createPropertiesContent((ServiceVersion) metadata, properties);
    ...
    @Override
    public ServiceVersion get(Resource resource, Registry registry) throws MetadataException {
        try {
    ...
    private ServiceVersion getFilledBean(OMElement root, Map<String, List<String>> propBag, Registry registry) throws MetadataException {
    ...
    private void createPropertiesContent(ServiceVersion serviceVersion, OMElement element) {
        OMFactory factory = OMAbstractFactory.getOMFactory();
        for (Map.Entry<String, List<String>> entry : serviceVersion.getPropertyBag().entrySet()) {
