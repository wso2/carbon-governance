...
public class EndpointVersion extends VersionBase {
...
//  Variables defined for internal implementation purpose
    ...
    private static final Log log = LogFactory.getLog(EndpointVersion.class);

    public EndpointVersion(Registry registry, String name) throws MetadataException {
        super(mediaType,name,registry);
        this.name = name;
    }

    public EndpointVersion(Registry registry, String name, String uuid, String baseName, String baseUUID, Map<String, List<String>> propertyBag, Map<String, List<String>> attributeMap) throws MetadataException {
     ...
     */
    public static EndpointVersion[] getAll(Registry registry) throws MetadataException {
        List<VersionBase> list = getAll(registry, mediaType);
        return list.toArray(new EndpointVersion[list.size()]);
    }
     ...
     * @return
     */
    public static EndpointVersion[] find(Registry registry, Map<String, String> criteria) throws MetadataException {
     ...
     */
    public static EndpointVersion get(Registry registry, String uuid) throws MetadataException {
        return (EndpointVersion) get(registry, uuid, mediaType);
    }
