...
public class PublisherCheckListItemUncheckedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "PublisherCheckListItemUnchecked";

    public PublisherCheckListItemUncheckedEvent() {
        super();
    }
     ...
     */
    public PublisherCheckListItemUncheckedEvent(T message) {
        super(message);
    }
