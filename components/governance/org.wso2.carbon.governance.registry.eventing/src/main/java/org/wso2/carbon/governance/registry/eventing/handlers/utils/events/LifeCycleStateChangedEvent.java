...
public class LifeCycleStateChangedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "LifeCycleStateChanged";
     ...
     */
    public LifeCycleStateChangedEvent(T message) {
        super(message);
    }
