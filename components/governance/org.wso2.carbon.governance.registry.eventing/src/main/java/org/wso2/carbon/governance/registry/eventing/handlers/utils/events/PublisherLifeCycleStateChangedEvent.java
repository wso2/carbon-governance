...
public class PublisherLifeCycleStateChangedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "PublisherLifeCycleStateChanged";

    public PublisherLifeCycleStateChangedEvent() {
        super();
    }
     ...
     */
    public PublisherLifeCycleStateChangedEvent(T message) {
        super(message);
    }
