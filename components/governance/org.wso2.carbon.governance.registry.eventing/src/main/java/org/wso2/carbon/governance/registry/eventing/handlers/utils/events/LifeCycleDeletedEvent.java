...
public class LifeCycleDeletedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "LifeCycleDeleted";

    public LifeCycleDeletedEvent() {
        super();
    }
     ...
     */
    public LifeCycleDeletedEvent(T message) {
        super(message);
    }
