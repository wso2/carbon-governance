...
public class StoreLifeCycleStateChangedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "StoreLifeCycleStateChanged";

    public StoreLifeCycleStateChangedEvent() {
        super();
    }
     ...
     */
    public StoreLifeCycleStateChangedEvent(T message) {
        super(message);
    }
