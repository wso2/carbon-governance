...
public class PublisherCheckListItemCheckedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "PublisherCheckListItemChecked";

    public PublisherCheckListItemCheckedEvent() {
        super();
    }
     ...
     */
    public PublisherCheckListItemCheckedEvent(T message) {
        super(message);
    }
