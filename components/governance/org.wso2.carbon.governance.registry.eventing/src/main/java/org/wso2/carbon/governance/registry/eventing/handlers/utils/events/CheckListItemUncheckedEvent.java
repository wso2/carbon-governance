...
public class CheckListItemUncheckedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "CheckListItemUnchecked";

    public CheckListItemUncheckedEvent() {
        super();
    }
     ...
     */
    public CheckListItemUncheckedEvent(T message) {
        super(message);
    }
