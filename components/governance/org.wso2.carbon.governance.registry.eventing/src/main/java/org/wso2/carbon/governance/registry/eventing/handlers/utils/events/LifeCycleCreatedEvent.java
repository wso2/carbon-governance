...
public class LifeCycleCreatedEvent<T> extends RegistryEvent<T> {

    private String resourcePath = null;

    public static final String EVENT_NAME = "LifeCycleCreated";

    public LifeCycleCreatedEvent() {
        super();
    }
     ...
     */
    public LifeCycleCreatedEvent(T message) {
        super(message);
    }
