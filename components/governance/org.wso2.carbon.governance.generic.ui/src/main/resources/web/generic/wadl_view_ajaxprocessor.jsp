...
<fmt:bundle basename="org.wso2.carbon.governance.generic.ui.i18n.Resources">
    ...
    <%
        ...
        try {
            ...
            if (cb.getCollection()) {
                throw new Exception("The resource custom ui doesn't support WADL content as a collection.");
            }
            textContent = client.getTextContent(request);
            WADLTreeNodeBuilder treeNodeBuilder = new WADLTreeNodeBuilder(path, textContent);
