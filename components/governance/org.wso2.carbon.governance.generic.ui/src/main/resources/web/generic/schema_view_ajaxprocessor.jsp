...
<fmt:bundle basename="org.wso2.carbon.governance.generic.ui.i18n.Resources">
    ...
    Click on the <a onclick="viewStandardContentSection('<%=Encode.forUriComponent(path)%>')">Standard
    view</a> to view, edit, download or <a
        onclick="visualizeXML('<%=Encode.forUriComponent(path)%>', 'xsd')">visualize</a> the schema.
    <%
            return;
        }
    ...
    <div class="yui-skin-sam">
        ...
        <p style="margin: 10px !important;">
            Click on the <a onclick="viewStandardContentSection('<%=Encode.forUriComponent(path)%>')">Standard view</a>
            to view, edit, download or <a
                onclick="visualizeXML('<%=Encode.forUriComponent(path)%>', 'xsd')">visualize</a> the schema.
        </p>
        <br/>
