...
<%
    ...
    boolean isUserAuthorized = CarbonUIUtil
            .isUserAuthorized(request, "/permission/admin/configure/governance/manage-rxt");
    try {
    ...
    <div id="middle">
        ...
        <div id="workArea">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="icon-link" style="background-image: url(../admin/images/edit.gif);"
                           href="source_artifact.jsp?view=true&path=<%=rxtPath%>"><fmt:message key="view"/></a>
                        <a class="icon-link"
                           style="background-image:url(../generic/images/delete-desable.gif);color:#aaa !important;cursor:default;"><fmt:message
                                key="delete"/></a>
                        <%} else { %>
                        <a class="icon-link" style="background-image: url(../admin/images/edit.gif);"
                           href="source_artifact.jsp?path=<%=rxtPath%>&rxtName=<%=rxt%>"><fmt:message
                                key="view.edit"/></a>
                        <%if (installedRxt.isDeleteAllowed()) { %>
                        <a href="#"
                           onclick="deleteArtifact('<%=rxtPath%>','/','../generic/generic_artifact.jsp?region=region3&item=governance_generic_menu')"
            ...
            <div class="registryWriteOperation" style="height:25px;">
                ...
                %>
                <a class="icon-link" style="background-image: url(../admin/images/add.gif);" href="source_artifact.jsp"><fmt:message
                        key="add.new.artifact"/></a>
                <% } %>
            </div>
        </div>
