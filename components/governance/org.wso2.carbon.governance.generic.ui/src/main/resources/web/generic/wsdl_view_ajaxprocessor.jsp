...
<%@ page import="org.wso2.carbon.governance.generic.ui.utils.WSDLTreeNodeBuilder" %>
...
<fmt:bundle basename="org.wso2.carbon.governance.generic.ui.i18n.Resources">
    ...
    <%
        ...
        try {
            ...
            WSDLTreeNodeBuilder treeNodeBuilder = new WSDLTreeNodeBuilder(path, textContent);
    ...
    Click on the <a onclick="viewStandardContentSectionWithNoEdit('<%=Encode.forHtml(path)%>')">Standard
    view</a> to view, edit, download or <a
        onclick="visualizeXML('<%=Encode.forHtml(path)%>', 'wsdl')">visualize</a> the wsdl.
    <%
            return;
        }
    ...
    <div class="yui-skin-sam">
        ...
        <p style="margin: 10px !important;">
            Click on the <a onclick="viewStandardContentSection('<%=Encode.forHtml(path)%>')">Standard view</a> to view,
            edit, download or <a onclick="visualizeXML('<%=Encode.forHtml(path)%>', 'wsdl')">visualize</a> the wsdl.
        </p>
        <br/>
        <div id="expandcontractdiv" style="margin-bottom:10px;">
            ...
            <a id="collapse" href="#" style="margin-left:20px"><img src="../generic/images/contractall.gif"
                                                                    align="top"/> Collapse all</a>
        </div>
