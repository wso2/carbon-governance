...
<link rel="stylesheet" type="text/css" href="../generic/css/treeview.css" />
        <div class="yui-skin-sam">
            ...
            <p style="margin: 10px !important;">
                Click on the <a onclick="viewStandardContentSection('<%=Encode.forHtmlContent(path)%>')">Standard view</a> to view, edit, download or <a onclick="visualizeXML('<%=Encode.forHtmlContent(path)%>', 'wsdl')">visualize</a> the wsdl.
            </p>
            <br/>
