...
<fmt:bundle basename="org.wso2.carbon.governance.generic.ui.i18n.Resources">
    ...
    <%
        ...
        if (relativePath.startsWith(RegistryConstants.GOVERNANCE_REGISTRY_BASE_PATH)) {
            relativePath = relativePath.substring(RegistryConstants.GOVERNANCE_REGISTRY_BASE_PATH.length());
        }
        ...
        while (widgets.hasNext()) {
            ...
            String widgetText = gen.printWidgetWithValues(widget, data, false, true, true, request, config)
                    .replace("\n", "<!--LF-->").replace("\r", "<!--CR-->");
    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <form id="CustomUIForm" action="../generic/add_ajaxprocessor.jsp" method="post">
                ...
                <input type="hidden" name="item" value="<%=Encode.forHtml(request.getParameter("add_edit_item"))%>"/>
                ...
                <input type="hidden" name="currentPath"
                       value="<%=(request.getParameter("path") != null ? Encode.forHtml(request.getParameter("path")) : "")%>"/>
                    ...
                    <tr id="buttonRow">
                        <td colspan="3" class="buttonRow">
                            ...
                            <input class="<%=saveButtonClass%>" type="button" <%=disabledAttr%>
                                   value="<fmt:message key="save.artifact"><fmt:param value="<%=breadcrumb%>"/></fmt:message>"
                                   onclick="addEditArtifact()"/>
                            <%
                                    }
                                }
                            %>
