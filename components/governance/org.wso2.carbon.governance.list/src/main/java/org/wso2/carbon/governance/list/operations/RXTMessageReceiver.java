...
public class RXTMessageReceiver implements MessageReceiver {
    ...
    Map<String, MessageProcessor> processorMap = new HashMap<String, MessageProcessor>();

    public void setMessageProcessor(String operation, MessageProcessor processor) {
        processorMap.put(operation, processor);
    }
