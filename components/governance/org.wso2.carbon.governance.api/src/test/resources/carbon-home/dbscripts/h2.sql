...
CREATE TABLE IF NOT EXISTS REG_CHECKPOINT_SCHEDULER (
    SCH_ID INTEGER NOT NULL AUTO_INCREMENT,
    REG_PATH VARCHAR(2000) NOT NULL,
    LC_NAME VARCHAR(256) NOT NULL,
    SCH_LC_STATE_UPDATED_DATE VARCHAR(25) NOT NULL,
    SCH_LC_CHECKPOINT_ID VARCHAR(256) NOT NULL,
    SCH_LC_CHECKPOINT_DURATION VARCHAR(256) NOT NULL,
    UUID VARCHAR(36) NOT NULL,
    REG_TENANT_ID INTEGER NOT NULL,
    PRIMARY KEY (SCH_ID)
);
-- ################################
-- USER MANAGER TABLES
